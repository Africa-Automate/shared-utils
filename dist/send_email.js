...
const microsoft_azure_1 = __importDefault(require("../src/v1/microsoft_azure"));
// /**
 ...
 */
function sendEmail(subject, content, destinationEmails, attachments) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const response = yield microsoft_azure_1.default
                .api(`/users/${USER_EMAIL}/sendMail`)
                .post(emailMessage);
            console.log("✅ Email sent successfully!");
            return response;
